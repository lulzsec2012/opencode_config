...
for _pkg in opencode-debug-helper opencode-agent-context opencode-codegraph opencode-mem opencode-skill-creator opencode-yaml-hooks opencode-skills-collection opencode-refactor-agent; do
